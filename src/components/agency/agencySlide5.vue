<template>
  <div id="slide-7" class="slide mx-83 pt-67 pb-40 h-screen relative flex flex-col h-125">
    <div class="flex justify-between">
      <p class="text-3.55xl w-87.5">А теперь давай поговорим о твоем проекте!</p>
      <img src="../../assets/images/slide_7/targe.svg" class="w-12.5 h-12.5" alt="">
    </div>
    <div class="flex flex-col">
      <p class="w-87.5 text-lg mb-25 ml-42p" style="color: rgba(192, 197, 216, 1); line-height: 1.875rem;">Мы готовы быстро и легко решить все твои сложные цифровые проблемы</p>
    ...
    <div class="flex justify-between mt-auto">
      ...
      <div class="w-5 h-px" style="background:rgba(151, 163, 203, 0.6);"></div>
    </div>
  </div>
</template>
